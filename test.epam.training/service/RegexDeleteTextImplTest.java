...
import by.training.homework5.service.impl.RegexDeleteTextImpl;
...
public class RegexDeleteTextImplTest {
    RegexDeleteTextImpl delete;

    @BeforeClass
    public void setUp() {
        delete = new RegexDeleteTextImpl();
    }

    @DataProvider(name = "dataToDeleteWordsByLengthValid")
    public Object[][] createDataToDeleteWordsByLengthValid() {
        return new Object[][]{
                {"hello world. My is Ivano", 5, ". My is Ivano"},
